...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="border shadow" style="padding: 20px; border-radius: 10px; position: absolute; top: 25%; left: 35%;">
                <div class="text-center">
                    <h4>Login</h4>
                </div>
                <div class="form-group py-2">
                    <label for="TextBox1">Email address</label>
                    <asp:TextBox ID="TextBox1" Type="email" runat="server" CssClass="form-control" placeholder="Enter Email ID"></asp:TextBox>
